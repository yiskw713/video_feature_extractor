...
if __name__ == '__main__':
    ...
    parser.add_argument(
        ...
        default='',
        type=str,
        help='Dataset name (kinetics | mit | ucf101 | hmdb51 | activitynet | msrvtt)')
    parser.add_argument(
    ...
    if args.dataset in ['kinetics', 'mit', 'activitynet', 'msrvtt']:
        ext = '.mp4'
    else:
        ext = '.avi'

    if args.dataset == 'activitynet' or args.dataset == 'msrvtt':
